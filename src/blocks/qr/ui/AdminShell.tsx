 ...
 * левое меню 208px + верхняя полоса. Устроен как `catalog/ui/AdminShell.tsx` и
 * `editor/ui/AdminShell.tsx` — но это третья копия, а не общий импорт: у каждого
 * блока свой активный пункт меню и свой словарь (`qr.nav.*`), а тянуть каркас из
