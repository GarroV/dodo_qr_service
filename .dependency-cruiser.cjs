// Границы модулей выведены из графа блоков в docs/forge/plan.md.
...
module.exports = {
  forbidden: [
    ...blockRules,
    {
      ...
      comment: 'Публичный маршрут заполнения не имеет права зависеть от входа в админку',
      severity: 'error',
      from: { path: '^src/app/s/' },
    ...
    },
    {
      ...
      comment: 'В базу ходит только блок data — остальные через его слой доступа',
      severity: 'error',
