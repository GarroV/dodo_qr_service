...
| Q003 | open | — | Где продукт живёт после пилота, в контуре компании: какая площадка, кто её даёт? (спрошено 2026-09-05) | — |
| Q004 | open | — | Есть ли бюджет на внешние сервисы после переезда в контур компании? (спрошено 2026-09-05) | — |
