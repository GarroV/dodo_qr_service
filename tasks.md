...
| T015 | catalog | T012,T014 | in_progress | Справочник стран, пиццерий и станций: создание, правка, удаление с подтверждением и без висячих станций | — | 1 |
| T016 | catalog | T015 | in_progress | Код станции: 10 символов криптографически случайно, без похожих знаков; перевыпуск ломает старый код сразу | — | 1 |
| T017 | catalog | T015 | in_progress | Привязка чек-листа к станции; станция без назначенного чек-листа помечена явно | — | 1 |
| T018 | catalog | T015 | in_progress | Экран справочника по эталону docs/forge/design/screens/catalog.html | — | 1 |
...
| T062 | catalog | T015 | in_progress | Проверка часового пояса при создании и правке пиццерии: опечатка в названии зоны сейчас проходит запись и роняет публичный маршрут всех станций этой пиццерии при каждом сканировании | — | 1 |
