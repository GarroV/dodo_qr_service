...
| T070 | core | T008 | todo | Тестовая база одна на все копии репозитория: два одновременных прогона сносят друг другу схему, и упавший тест выглядит случайным. Развести адрес тестовой базы по копиям — как разведены порты и имена compose-проектов | — | 1 |
