...
| T055 | chores | — | todo | Разобраться с 4 moderate-уязвимостями npm audit в esbuild внутри drizzle-kit: только для разработки, лечится откатом drizzle-kit до 0.18 — решить, терпим или откатываем | — | 1 |
